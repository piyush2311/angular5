...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__shared_sdk_index__ = __webpack_require__("./src/app/shared/sdk/index.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__core_navbar_navbar_component__ = __webpack_require__("./src/app/core/navbar/navbar.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__core_footer_footer_component__ = __webpack_require__("./src/app/core/footer/footer.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__shared_service__ = __webpack_require__("./src/app/shared.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__core_config__ = __webpack_require__("./src/app/core/config.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_9__core_navbar_navbar_component__["a" /* NavbarComponent */],
                __WEBPACK_IMPORTED_MODULE_10__core_footer_footer_component__["a" /* FooterComponent */]
            ],
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_8__shared_sdk_index__["d" /* SDKBrowserModule */].forRoot()
            ],
            exports: [],
            providers: [__WEBPACK_IMPORTED_MODULE_6__data_service__["a" /* DataService */], __WEBPACK_IMPORTED_MODULE_13__shared_service__["a" /* SharedService */], __WEBPACK_IMPORTED_MODULE_14__core_config__["a" /* ConfigComponent */]],
...
var ConfigComponent = /** @class */ (function () {
    ...
    ], ConfigComponent.prototype, "apiUrl", void 0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__shared_sdk_services__ = __webpack_require__("./src/app/shared/sdk/services/index.ts");
...
var NavbarComponent = /** @class */ (function () {
    function NavbarComponent(memberApi, router, dataService, sharedService) {
        this.memberApi = memberApi;
        this.router = router;
        this.dataService = dataService;
        this.sharedService = sharedService;
        this.isLogin = false;
        this.isToggleUp = false;
        this.userDate = [];
    }
    NavbarComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.isLogin = this.memberApi.isAuthenticated();
        this.sharedService.session$.subscribe(function (data) {
            if (data && data.length) {
                _this.userDate = data;
            }
        });
    ...
    NavbarComponent.prototype.logout = function () {
        var _this = this;
        this.isLogin = false;
        this.memberApi.logout().subscribe(function (data) { return _this.setAuthChanged(false); });
    };
    NavbarComponent.prototype.setAuthChanged = function (flag) {
        this.userDate = [];
    ...
    NavbarComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__shared_sdk_services__["a" /* MemberApi */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_sdk__ = __webpack_require__("./src/app/shared/sdk/index.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_sdk_services__ = __webpack_require__("./src/app/shared/sdk/services/index.ts");
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(memberApi, router, dataService, sharedService) {
        this.memberApi = memberApi;
        this.router = router;
        this.dataService = dataService;
        this.sharedService = sharedService;
        this.userData = [{ isLogin: false, userData: { 'firstName': 'piyush', 'lastName': 'kriplani' } }];
        __WEBPACK_IMPORTED_MODULE_2__shared_sdk__["c" /* LoopBackConfig */].setBaseURL(__WEBPACK_IMPORTED_MODULE_2__shared_sdk__["b" /* BASE_URL */]);
        __WEBPACK_IMPORTED_MODULE_2__shared_sdk__["c" /* LoopBackConfig */].setApiVersion(__WEBPACK_IMPORTED_MODULE_2__shared_sdk__["a" /* API_VERSION */]);
    }
    ...
    DashboardComponent.prototype.logout = function () {
        var _this = this;
        this.memberApi.logout().subscribe(function (data) {
    ...
    DashboardComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__shared_sdk_services__["a" /* MemberApi */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__shared_sdk_services__ = __webpack_require__("./src/app/shared/sdk/services/index.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__core_config__ = __webpack_require__("./src/app/core/config.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DataService = /** @class */ (function () {
    function DataService(http, memberApi, config) {
        this.http = http;
        this.memberApi = memberApi;
        this.config = config;
    ...
    DataService.prototype.setAutenticationChanged = function (flag) {
        this.userAuthChanged(flag);
    };
    DataService.prototype.userAuthChanged = function (status) {
    ...
    ], DataService.prototype, "authChanged", void 0);
    DataService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["A" /* Injectable */])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_common_http__["a" /* HttpClient */], __WEBPACK_IMPORTED_MODULE_6__shared_sdk_services__["a" /* MemberApi */], __WEBPACK_IMPORTED_MODULE_7__core_config__["a" /* ConfigComponent */]])
    ], DataService);
    return DataService;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__data_service__ = __webpack_require__("./src/app/data.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_sdk__ = __webpack_require__("./src/app/shared/sdk/index.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_sdk_models__ = __webpack_require__("./src/app/shared/sdk/models/index.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__shared_sdk_services__ = __webpack_require__("./src/app/shared/sdk/services/index.ts");
...
var LoginComponent = /** @class */ (function () {
     ...
     * @param dataService
     */
    function LoginComponent(memberApi, router, dataService) {
        this.memberApi = memberApi;
        this.router = router;
        this.dataService = dataService;
        this.addUser = new __WEBPACK_IMPORTED_MODULE_3__shared_sdk_models__["b" /* Member */]();
        this.isLogin = false;
        __WEBPACK_IMPORTED_MODULE_2__shared_sdk__["c" /* LoopBackConfig */].setBaseURL(__WEBPACK_IMPORTED_MODULE_2__shared_sdk__["b" /* BASE_URL */]);
        __WEBPACK_IMPORTED_MODULE_2__shared_sdk__["c" /* LoopBackConfig */].setApiVersion(__WEBPACK_IMPORTED_MODULE_2__shared_sdk__["a" /* API_VERSION */]);
        if (this.memberApi.isAuthenticated()) {
    ...
    LoginComponent.prototype.login = function () {
        var _this = this;
        this.memberApi.login(this.addUser, {}).subscribe(function (data) { return _this.router.navigate(['/dashboard']); }, function (err) { return console.log(err); });
    };
    LoginComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4__shared_sdk_services__["a" /* MemberApi */],
...
var SharedService = /** @class */ (function () {
    function SharedService() {
        this.session = new __WEBPACK_IMPORTED_MODULE_1_rxjs_Subject__["a" /* Subject */]();
        this.session$ = this.session.asObservable();
    }
    SharedService.prototype.setSession = function (userData) {
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return SDKBrowserModule; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__services_custom_Member__ = __webpack_require__("./src/app/shared/sdk/services/custom/Member.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__services_custom_Test__ = __webpack_require__("./src/app/shared/sdk/services/custom/Test.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__models_index__ = __webpack_require__("./src/app/shared/sdk/models/index.ts");
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__services_index__ = __webpack_require__("./src/app/shared/sdk/services/index.ts");
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__lb_config__ = __webpack_require__("./src/app/shared/sdk/lb.config.ts");
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "c", function() { return __WEBPACK_IMPORTED_MODULE_19__lb_config__["a"]; });
/* unused harmony namespace reexport */
    ...
    SDKBrowserModule.forRoot = function (internalStorageProvider) {
        ...
        return {
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_15__services_custom_Member__["a" /* MemberApi */],
                __WEBPACK_IMPORTED_MODULE_16__services_custom_Test__["a" /* TestApi */],
...
var BASE_URL = 'http://localhost:3024';
var API_VERSION = 'api';
...
var LoopBackConfig = /** @class */ (function () {
    ...
    LoopBackConfig.path = '//192.168.1.107:3022';
...
/***/ "./src/app/shared/sdk/models/Member.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var Member = /** @class */ (function () {
    ...
    * definitions.
    **/
    Member.getModelDefinition = function () {
        return {
            name: 'Member',
            plural: 'Members',
            path: 'Members',
...
/***/ "./src/app/shared/sdk/models/Test.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var Test = /** @class */ (function () {
    ...
    * definitions.
    **/
    Test.getModelDefinition = function () {
        return {
            name: 'Test',
            plural: 'Tests',
            path: 'Tests',
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Member__ = __webpack_require__("./src/app/shared/sdk/models/Member.ts");
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_0__Member__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Test__ = __webpack_require__("./src/app/shared/sdk/models/Test.ts");
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__BaseModels__ = __webpack_require__("./src/app/shared/sdk/models/BaseModels.ts");
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__FireLoopRef__ = __webpack_require__("./src/app/shared/sdk/models/FireLoopRef.ts");
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_3__FireLoopRef__["a"]; });
/* tslint:disable */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__io_service__ = __webpack_require__("./src/app/shared/sdk/services/core/io.service.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__models_FireLoop__ = __webpack_require__("./src/app/shared/sdk/models/FireLoop.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__sockets_socket_connections__ = __webpack_require__("./src/app/shared/sdk/sockets/socket.connections.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__custom_SDKModels__ = __webpack_require__("./src/app/shared/sdk/services/custom/SDKModels.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_rxjs_Subject__ = __webpack_require__("./node_modules/rxjs/_esm5/Subject.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
/***/ "./src/app/shared/sdk/services/custom/Member.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var MemberApi = /** @class */ (function (_super) {
    ...
    function MemberApi(http, connection, models, auth, searchParams, errorHandler) {
     ...
     * </em>
     */
    MemberApi.prototype.findByIdAccessTokens = function (id, fk, customHeaders) {
        var _method = "GET";
     ...
     */
    MemberApi.prototype.destroyByIdAccessTokens = function (id, fk, customHeaders) {
        var _method = "DELETE";
        var _url = __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getPath() + "/" + __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getApiVersion() +
            "/Members/:id/accessTokens/:fk";
        var _routeParams = {
     ...
     * </em>
     */
    MemberApi.prototype.updateByIdAccessTokens = function (id, fk, data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PUT";
        var _url = __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getPath() + "/" + __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getApiVersion() +
            "/Members/:id/accessTokens/:fk";
     ...
     * </em>
     */
    MemberApi.prototype.getAccessTokens = function (id, filter, customHeaders) {
        if (filter === void 0) { filter = {}; }
        var _method = "GET";
        var _url = __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getPath() + "/" + __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getApiVersion() +
     ...
     * </em>
     */
    MemberApi.prototype.createAccessTokens = function (id, data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "POST";
        var _url = __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getPath() + "/" + __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getApiVersion() +
            "/Members/:id/accessTokens";
     ...
     * This method returns no data.
     */
    MemberApi.prototype.deleteAccessTokens = function (id, customHeaders) {
        var _method = "DELETE";
        var _url = __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getPath() + "/" + __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getApiVersion() +
            "/Members/:id/accessTokens";
        var _routeParams = {
     ...
     *  - `count` – `{number}` -
     */
    MemberApi.prototype.countAccessTokens = function (id, where, customHeaders) {
        if (where === void 0) { where = {}; }
        var _method = "GET";
        var _url = __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getPath() + "/" + __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getApiVersion() +
     ...
     * </em>
     */
    MemberApi.prototype.patchOrCreate = function (data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getPath() + "/" + __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getApiVersion() +
            "/Members";
     ...
     * </em>
     */
    MemberApi.prototype.patchAttributes = function (id, data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getPath() + "/" + __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getApiVersion() +
            "/Members/:id";
     ...
     *
     */
    MemberApi.prototype.login = function (credentials, include, rememberMe, customHeaders) {
        var _this = this;
     ...
     * This method returns no data.
     */
    MemberApi.prototype.logout = function (customHeaders) {
        var _method = "POST";
        var _url = __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getPath() + "/" + __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getApiVersion() +
            "/Members/logout";
        var _routeParams = {};
     ...
     * This method returns no data.
     */
    MemberApi.prototype.verify = function (id, customHeaders) {
        var _method = "POST";
        var _url = __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getPath() + "/" + __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getApiVersion() +
            "/Members/:id/verify";
        var _routeParams = {
     ...
     * This method returns no data.
     */
    MemberApi.prototype.confirm = function (uid, token, redirect, customHeaders) {
     ...
     * This method returns no data.
     */
    MemberApi.prototype.resetPassword = function (options, customHeaders) {
        var _method = "POST";
        var _url = __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getPath() + "/" + __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getApiVersion() +
            "/Members/reset";
        var _routeParams = {};
     ...
     * This method returns no data.
     */
    MemberApi.prototype.changePassword = function (oldPassword, newPassword, customHeaders) {
        var _method = "POST";
        var _url = __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getPath() + "/" + __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getApiVersion() +
     ...
     * This method returns no data.
     */
    MemberApi.prototype.setPassword = function (newPassword, customHeaders) {
        var _method = "POST";
        var _url = __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getPath() + "/" + __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getApiVersion() +
     ...
     * </em>
     */
    MemberApi.prototype.createManyAccessTokens = function (id, data, customHeaders) {
        if (data === void 0) { data = []; }
        var _method = "POST";
        var _url = __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getPath() + "/" + __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getApiVersion() +
            "/Members/:id/accessTokens";
     ...
     *   from the server.
     */
    MemberApi.prototype.getCurrent = function (filter) {
        if (filter === void 0) { filter = {}; }
        var _method = "GET";
        var _url = __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getPath() + "/" + __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getApiVersion() + "/Members" + "/:id";
     ...
     */
    MemberApi.prototype.getCachedCurrent = function () {
     ...
     */
    MemberApi.prototype.getCurrentToken = function () {
     ...
     */
    MemberApi.prototype.isAuthenticated = function () {
     ...
     */
    MemberApi.prototype.getCurrentId = function () {
     ...
     * i.e. `Member`.
     */
    MemberApi.prototype.getModelName = function () {
        return "Member";
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__models_Member__ = __webpack_require__("./src/app/shared/sdk/models/Member.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__models_Test__ = __webpack_require__("./src/app/shared/sdk/models/Test.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SDKModels = /** @class */ (function () {
    function SDKModels() {
        this.models = {
            Member: __WEBPACK_IMPORTED_MODULE_1__models_Member__["a" /* Member */],
            Test: __WEBPACK_IMPORTED_MODULE_2__models_Test__["a" /* Test */],
        };
    }
...
/***/ "./src/app/shared/sdk/services/custom/Test.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return TestApi; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_http__ = __webpack_require__("./node_modules/@angular/http/esm5/http.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__SDKModels__ = __webpack_require__("./src/app/shared/sdk/services/custom/SDKModels.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__core_base_service__ = __webpack_require__("./src/app/shared/sdk/services/core/base.service.ts");
...
var TestApi = /** @class */ (function (_super) {
    ...
    function TestApi(http, connection, models, auth, searchParams, errorHandler) {
        var _this = _super.call(this, http, connection, models, auth, searchParams, errorHandler) || this;
        _this.http = http;
        _this.connection = connection;
        _this.models = models;
     ...
     * </em>
     */
    TestApi.prototype.patchOrCreate = function (data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getPath() + "/" + __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getApiVersion() +
            "/tests";
     ...
     * </em>
     */
    TestApi.prototype.patchAttributes = function (id, data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getPath() + "/" + __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getApiVersion() +
            "/tests/:id";
     ...
     * i.e. `Test`.
     */
    TestApi.prototype.getModelName = function () {
        return "Test";
    };
    TestApi = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["A" /* Injectable */])(),
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Member__ = __webpack_require__("./src/app/shared/sdk/services/custom/Member.ts");
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_0__Member__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Test__ = __webpack_require__("./src/app/shared/sdk/services/custom/Test.ts");
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__SDKModels__ = __webpack_require__("./src/app/shared/sdk/services/custom/SDKModels.ts");
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__logger_service__ = __webpack_require__("./src/app/shared/sdk/services/custom/logger.service.ts");
/* unused harmony namespace reexport */
/* tslint:disable */
